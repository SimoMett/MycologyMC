...
public class FabricCommonConfigs implements IModCommonConfigs
{
    private static final FabricCommonConfigs INSTANCE = new FabricCommonConfigs();

    public static IModCommonConfigs instance()
    {
        return INSTANCE;
    }
